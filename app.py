...
# Display emotions vertically and colored with emojis
emotions = {
    'Joy': '😄',
    'Fear': '😨',
    'Anger': '😠',
...
for emotion, emoji in emotions.items():
   st.write(f"<span style='color:rgb(255, 165, 0); font-size:16px; font-weight:bold'>{emoji} {emotion}:</span>", unsafe_allow_html=True)
